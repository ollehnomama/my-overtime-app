                ...
                if not name:
                    ...
                    if end_dt <= start_dt:
                        ...
                        try:
                            ...
                            # 成功訊息 (注意：這裡移除了 st.rerun()，確保訊息會顯示出來)
                            st.success(f"✅ 已成功送出！ {name} - {apply_type} {duration}hr")
                            
                        except Exception as e:
                            st.error(f"存檔失敗，請截圖通知管理員：{str(e)}")
